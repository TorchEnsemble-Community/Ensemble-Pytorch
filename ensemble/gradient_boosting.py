...
class GradientBoostingClassifier(BaseModule):
    ...
    def _validate_parameters(self):
        ...
        if not self.n_estimators > 0:
            msg = 'The number of base estimators = {} should be strictly positive.'
        ...
        if not self.lr > 0:
            msg = 'The learning rate of optimizer = {} should be strictly positive.'
    ...
    # the index of each sample in the original dataset to be kept in the memory.
    ...
    def fit(self, train_loader):
        ...
        for est_idx, estimator in enumerate(self.estimators_):
            ...
            learner_optimizer = torch.optim.Adam(estimator.parameters(),
                                                 lr=self.lr,
